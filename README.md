...
<p align="center"><strong>v0.1.3 Beta</strong> · Open-source Linux gaming hub — unified audio mixer, device/RGB manager, and instant replay.<br>A modular alternative to SteelSeries GG (Sonar + Engine + Moments).</p>
